...
`경로 / Đường dẫn`: `/PosUI/src/screens/PaymentScreen/components`

## 한국어

### 역할
- components 화면의 실제 UI 구현을 담당한다.

### 담당 범위
- components 화면 진입점, UI 훅, 전용 컴포넌트, 상수
...
### Vai trò
- Thư mục này phụ trách UI thực tế của màn hình components.

### Phạm vi phụ trách
- Entry point, hook UI, component riêng và hằng số cho màn hình components
