...
`경로 / Đường dẫn`: `/PosUI/src/screens`

## 한국어

### 역할
- 실제 제품 화면을 배치하는 UI 영역이다.

### 담당 범위
- TableScreen, OrderScreen, PaymentScreen 등 실제 앱 화면
...
### Vai trò
- Đây là vùng đặt các màn hình thật của sản phẩm.

### Phạm vi phụ trách
- Các màn hình thật như TableScreen, OrderScreen, PaymentScreen
