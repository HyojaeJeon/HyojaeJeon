...
`경로 / Đường dẫn`: `/PosUI/src/screens/OrderScreen`

## 한국어

### 역할
- OrderScreen 화면의 실제 UI 구현을 담당한다.

### 담당 범위
- OrderScreen 화면 진입점, UI 훅, 전용 컴포넌트, 상수
...
### Vai trò
- Thư mục này phụ trách UI thực tế của màn hình OrderScreen.

### Phạm vi phụ trách
- Entry point, hook UI, component riêng và hằng số cho màn hình OrderScreen
