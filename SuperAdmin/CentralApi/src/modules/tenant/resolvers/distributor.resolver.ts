...
export class DistributorResolver {
  ...
  async brands(
    ...
    return context.loaders.brandsByDistributorId.load(distributor.id);
  }
   ...
   */
  @Query(() => DistributorProfileModel, { nullable: true })
  @Roles(RoleCode.PLATFORM_SUPER_ADMIN)
  async distributor(
   ...
   */
  @Mutation(() => DistributorProfileModel)
  @Roles(RoleCode.PLATFORM_SUPER_ADMIN)
