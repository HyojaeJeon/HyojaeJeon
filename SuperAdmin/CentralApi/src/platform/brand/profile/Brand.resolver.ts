...
import { BrandProfileModel } from './models/BrandProfile.model';
import { BranchModel } from '@platform/branch/profile/models/Branch.model';
import { BrandMenuCategoryModel } from '@platform/brand/catalog/menuCategory/models/BrandMenuCategory.model';
import { BrandMenuItemModel } from '@platform/brand/catalog/menuItem/models/BrandMenuItem.model';
import { PricePolicyModel } from '@platform/brand/catalog/pricePolicy/models/PricePolicy.model';
...
const BrandProfileModel__ListResp = createListResponse(BrandProfileModel, 'BrandProfileModelListResponse');
const BrandProfileModel__Resp = createObjectResponse(BrandProfileModel, 'BrandProfileModelResponse');
...
export class BrandResolver {
  ...
  async branches(
    ...
    return context.loaders.branchesByBrandHQId.load(brand.id) as unknown as Promise<BranchModel[]>;
  }
  ...
  async menuCategories(
    ...
    return context.loaders.menuCategoriesByBrandHQId.load(brand.id) as unknown as Promise<BrandMenuCategoryModel[]>;
  }
  ...
  async menuItems(
    ...
    return context.loaders.menuItemsByBrandHQId.load(brand.id) as unknown as Promise<BrandMenuItemModel[]>;
  }
  ...
  async pricePolicies(
    ...
    return context.loaders.pricePoliciesByBrandHQId.load(brand.id) as unknown as Promise<PricePolicyModel[]>;
  }
  ...
  async promotions(
    ...
    return context.loaders.promotionsByBrandHQId.load(brand.id) as unknown as Promise<PromotionModel[]>;
  }
   ...
   */
  @Query(() => BrandProfileModel__ListResp)
   ...
   */
  @Query(() => BrandProfileModel__Resp, { nullable: true })
  @RequirePermission('brands:read')
  async brand(
   ...
   */
  @Mutation(() => BrandProfileModel__Resp)
