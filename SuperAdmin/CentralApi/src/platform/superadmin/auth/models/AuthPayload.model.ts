...
import { AuthAccountModel } from './AuthAccount.model';
...
export class AuthPayload {
  ...
  /** 한국어: access token 만료 시각 / Tiếng Việt: Thời điểm access token hết hạn */
  @Field()
  accessTokenExpiresAt!: Date;

  /** 한국어: refresh session 절대 만료 시각 / Tiếng Việt: Thời điểm session refresh hết hạn tuyệt đối */
  @Field()
