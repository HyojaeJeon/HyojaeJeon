 ...
 */
import { REQUIRE_PERMISSIONS_KEY } from '@core/rbac/decorators/require-permission.decorator';
import { SELF_ACTION_KEY } from '@core/rbac/decorators/self-action.decorator';
...
import { MenuCategoryResolver } from '@platform/brand/catalog/menu-category/menu-category.resolver';
import { MenuItemResolver } from '@platform/brand/catalog/menu-item/menu-item.resolver';
import { PricePolicyResolver } from '@platform/brand/catalog/price-policy/price-policy.resolver';
import { PromotionResolver } from '@platform/brand/catalog/promotion/promotion.resolver';
import { EdgePosResolver } from '@platform/edge-pos/edge-pos.resolver';
