...
export const NAV_ITEMS: NavItem[] = [
  ...
  },
  {
    ...
    icon: 'ShieldCheck',
    children: [
      { key: 'governance.licenses', labelKey: 'nav.governance.licenses', href: '/governance/licenses', icon: 'BadgeCheck' },
      { key: 'governance.entitlements', labelKey: 'nav.governance.entitlements', href: '/governance/entitlements', icon: 'Grid2X2Check' },
      { key: 'governance.policies', labelKey: 'nav.governance.policies', href: '/governance/platform-policies', icon: 'SlidersHorizontal' },
      {
        key: 'governance.tenantUsers',
        labelKey: 'nav.governance.tenantUsers',
        href: '/governance/tenant-users',
        icon: 'ShieldCheck',
