...
function NavLink({
  ...
  // accordion: 현재 경로가 children 안에 있으면 자동 열림, 아니면 기본 접힘
  const [open, setOpen] = useState<boolean>(hasChildInPath);
  // 경로가 바뀌어 children 에 들어가면 자동 열기 (pathname dependency)
...
export function NavigationRail() {
  const collapsed = useAppSelector((s) => s.ui.navCollapsed);
