...
export function CorporateMerchantsScreen() {
  ...
  return (
    ...
    >
      {showEnroll && canWrite && (
        <SectionCard title={t('corporate.merchants.formTitle')} description="브랜드를 선택하고 loop type 을 지정합니다">
      ...
      <div className={showEnroll ? 'mt-3' : ''}>
        <SectionCard title={t('corporate.merchants.cardTitle')} description={`${enrollments.length} enrollment(s)`} padding="none">
