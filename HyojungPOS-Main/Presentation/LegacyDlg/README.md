...
`경로 / Đường dẫn`: `/HyojungPOS-Main/Presentation/LegacyDlg`

## 한국어

### 역할
- 점진 전환 기간 동안 유지되는 기존 MFC Dialog 영역이다.
...
### Vai trò
- Đây là vùng dialog MFC cũ được giữ lại trong giai đoạn migrate dần.
