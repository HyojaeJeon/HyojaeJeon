...
`경로 / Đường dẫn`: `/HyojungPOS-Main/Domain/Payment`

## 한국어

### 역할
- 결제 도메인의 업무 규칙, 상태 계산, Manager 구현을 담당한다.

### 담당 범위
- 결제 상태 전이, 계산 로직, Manager API, 도메인 결과 모델
...
### Vai trò
- Thư mục này phụ trách quy tắc nghiệp vụ, tính toán trạng thái và triển khai Manager cho miền thanh toán.

### Phạm vi phụ trách
- Chuyển trạng thái thanh toán, logic tính toán, Manager API và mô hình kết quả domain
