...
`경로 / Đường dẫn`: `/HyojungPOS-Main/Infrastructure/ExternalBridge/PaymentGateways/BCCard`

## 한국어

### 역할
- BC카드 외부 결제 연동 구현을 담당한다.

### 담당 범위
- BC카드 API 통신, 응답 파싱, 어댑터 구현
...
### Vai trò
- Thư mục này phụ trách triển khai tích hợp thanh toán bên ngoài BC Card.

### Phạm vi phụ trách
- Giao tiếp API BC Card, parse phản hồi và triển khai adapter
