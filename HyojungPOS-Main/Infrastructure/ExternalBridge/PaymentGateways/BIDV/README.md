...
`경로 / Đường dẫn`: `/HyojungPOS-Main/Infrastructure/ExternalBridge/PaymentGateways/BIDV`

## 한국어

### 역할
- BIDV 외부 결제 연동 구현을 담당한다.

### 담당 범위
- BIDV API 통신, 응답 파싱, 어댑터 구현
...
### Vai trò
- Thư mục này phụ trách triển khai tích hợp thanh toán bên ngoài BIDV.

### Phạm vi phụ trách
- Giao tiếp API BIDV, parse phản hồi và triển khai adapter
