...
`경로 / Đường dẫn`: `/HyojungPOS-Main/Infrastructure/ExternalBridge/PaymentGateways`

## 한국어

### 역할
- 외부 결제사 어댑터들을 모아두는 인프라 영역이다.

### 담당 범위
- 카드/QR/VAN/세금 모듈별 어댑터
...
### Vai trò
- Đây là vùng hạ tầng tập hợp các adapter kết nối cổng thanh toán bên ngoài.

### Phạm vi phụ trách
- Adapter theo từng loại thẻ/QR/VAN/mô-đun thuế
