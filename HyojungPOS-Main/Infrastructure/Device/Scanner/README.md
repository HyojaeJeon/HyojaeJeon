...
`경로 / Đường dẫn`: `/HyojungPOS-Main/Infrastructure/Device/Scanner`
...
### Vai trò
- Thư mục này phụ trách triển khai tích hợp thiết bị máy quét.

### Phạm vi phụ trách
- Điều khiển thiết bị máy quét, phát hiện trạng thái và chuyển đổi mã lỗi
