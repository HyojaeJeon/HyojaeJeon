...
`경로 / Đường dẫn`: `/HyojungPOS-Main/Infrastructure/Device/Printer`
...
### Vai trò
- Thư mục này phụ trách triển khai tích hợp thiết bị máy in.

### Phạm vi phụ trách
- Điều khiển thiết bị máy in, phát hiện trạng thái và chuyển đổi mã lỗi
