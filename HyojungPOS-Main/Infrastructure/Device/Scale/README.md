...
`경로 / Đường dẫn`: `/HyojungPOS-Main/Infrastructure/Device/Scale`
...
### Vai trò
- Thư mục này phụ trách triển khai tích hợp thiết bị cân.

### Phạm vi phụ trách
- Điều khiển thiết bị cân, phát hiện trạng thái và chuyển đổi mã lỗi
