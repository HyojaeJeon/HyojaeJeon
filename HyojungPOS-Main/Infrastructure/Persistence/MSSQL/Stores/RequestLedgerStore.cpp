...
RequestLedgerStore::RequestLedgerStore() {}
RequestLedgerStore::~RequestLedgerStore() {}

std::optional<LedgerEntry> RequestLedgerStore::Find(
...
void RequestLedgerStore::Upsert(
    const std::string& idempotency_key,
...
void RequestLedgerStore::UpdateStatus(
    const std::string& idempotency_key,
...
std::vector<LedgerEntry> RequestLedgerStore::FindStaleProcessing(int /*timeout_seconds*/)
{
