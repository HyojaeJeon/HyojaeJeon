...
`경로 / Đường dẫn`: `/HyojungPOS-Main/Infrastructure`
...
### 담당 범위
- Persistence, Sync, ExternalBridge, Device, Network, Observability, Support
...
### 해도 되는 것
- DB 연결, store, 동기화 워커, 외부 어댑터, 로깅을 구현한다.
...
### Phạm vi phụ trách
- Persistence, Sync, ExternalBridge, Device, Network, Observability và Support
...
### Được phép làm
- Triển khai kết nối DB, store, sync worker, adapter ngoài và logging.
- Cung cấp store/adapter kỹ thuật để UseCases sử dụng.
