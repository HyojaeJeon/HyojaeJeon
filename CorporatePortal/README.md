...
- 관리하는 리소스:
  ...
  - 임직원 식권 계정(Allowance Ledger) 발급·회수·회사 지원금 적립·개인 충전·원장 조회
  - 식대 정책(MealPolicy): 부서/직급/시간대/한도/Split Payment / Carryover
  - 예산(FundingAccount): Prepaid Deposit / Credit Net15·Net30 / 회사 지원금 / 개인 충전
...
/departments                   부서 트리
/employees                     임직원 / Allowance Ledger / 배지(RFID) 매핑
/policies                      정책 빌더 (시간대·부서·한도·Split·Carryover)
/budget                        회사 지원금, 개인 충전, 이월, 원장 내역, 소멸 정책
