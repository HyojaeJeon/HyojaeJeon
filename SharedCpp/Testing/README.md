...
`경로 / Đường dẫn`: `/SharedCpp/Testing`

## 한국어

### 역할
- 테스트 자산 관련 공용 C++ 자산을 제공하는 영역이다.

### 담당 범위
- 테스트 자산 범주의 공용 유틸, 계약, 관측성, 테스트 또는 빌드 지원
...
### Vai trò
- Đây là vùng cung cấp tài sản C++ dùng chung liên quan đến tài sản test.

### Phạm vi phụ trách
- Tiện ích, contract, observability, test hoặc build support thuộc nhóm tài sản test
