...
`경로 / Đường dẫn`: `/SharedCpp/Contracts`

## 한국어

### 역할
- 공용 계약 관련 공용 C++ 자산을 제공하는 영역이다.

### 담당 범위
- 공용 계약 범주의 공용 유틸, 계약, 관측성, 테스트 또는 빌드 지원
...
### 하면 안 되는 것
- 특정 앱 전용 기능을 SharedCpp에 넣지 않는다.
- 레이어 책임을 흐리는 business implementation을 추가하지 않는다.

## Tiếng Việt

### Vai trò
- Đây là vùng cung cấp tài sản C++ dùng chung liên quan đến contract dùng chung.

### Phạm vi phụ trách
- Tiện ích, contract, observability, test hoặc build support thuộc nhóm contract dùng chung
...
### Không được làm
- Không đặt chức năng chỉ dành cho một ứng dụng vào SharedCpp.
