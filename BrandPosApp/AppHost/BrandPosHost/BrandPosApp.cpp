/**
 * BrandPosApp.cpp — Điểm vào ứng dụng POS (Win32 + CEF)
 * BrandPosApp.cpp — POS 앱 진입점 (Win32 + CEF)
 *
...
static const wchar_t* kWindowClass = L"BrandPosApp_MainWindow";
static const wchar_t* kWindowTitle = L"BrandPosApp";
