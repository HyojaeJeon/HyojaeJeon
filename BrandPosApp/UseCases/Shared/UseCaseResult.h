...
struct UseCaseResult {
    ...
    static UseCaseResult Success(const std::string& dataJson) {
        return { true, "OK", dataJson, "", false };
    }

    static UseCaseResult Replay(const std::string& dataJson) {
        return { true, "OK", dataJson, "", true };
    }
