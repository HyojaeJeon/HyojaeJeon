...
const SECTION_KEYS: Record<string, string[]> = {
  ...
  'brandhq-design': ['goal', 'confirmed_spec', 'responsibility_flow', 'management_layers', 'data_ownership', 'settings_inheritance', 'deployment_sync', 'capability_entitlement_principles', 'capability_entitlement_data_model', 'capability_entitlement_server_rules', 'capability_entitlement_portal_rules', 'capability_entitlement_rbac', 'capability_entitlement_superadmin_ui', 'capability_entitlement_mealticket'],
  ...
  'mealticket-overview': ['purpose', 'subject_mapping', 'domain_boundaries', 'portal_matrix', 'offline_rules', 'split_triggers'],
  'mealticket-corporate': ['purpose', 'scope', 'routes', 'domain_model', 'rules'],
  'mealticket-merchant': ['purpose', 'brandhq_reuse', 'routes', 'enrollment_flag', 'closed_loop_terminal'],
