# Build Guide — BrandPosApp CEF + Next.js
# 빌드 가이드
...
```
BrandPosApp/Presentation/CEF/SDK/
...
```
BrandPosApp/Presentation/CEF/SDK/libcef_dll_wrapper/Release/libcef_dll_wrapper.lib
```
...
```cmd
xcopy /E /Y PosUi\out\* BrandPosApp\Build\PosUi\out\
```
...
```
BrandPosApp/Build/
├── BrandPosAppD.exe     (Debug)
├── BrandPosApp.exe      (Release)
