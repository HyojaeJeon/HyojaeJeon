...
`경로 / Đường dẫn`: `/SharedAssets/i18n/locales/ko`

## 한국어

### 역할
- ko locale 원본을 보관하는 폴더다.

### 담당 범위
- 공용 번역 키, 네임스페이스별 JSON, 언어별 원본 자산

### 규칙
- `SharedAssets/i18n/locales`가 번역의 유일한 진실의 원천이다.
...
### Vai trò
- Đây là thư mục lưu locale gốc của ngôn ngữ ko.

### Phạm vi phụ trách
- Key dịch dùng chung, JSON theo namespace và tài sản gốc theo từng ngôn ngữ

### Quy tắc
- `SharedAssets/i18n/locales` là nguồn sự thật duy nhất của bản dịch.
